...
const requestHandler = (req, res) => {
  ...
  if (url === "/message" && method === "POST") {
    //If the url is /message, then it will store the message the user entered and store it in the new file.
    const body = [];
    req.on("data", (chunk) => {
      //node will keep executing this as long as there is data to add.
      console.log(chunk);
      body.push(chunk);
